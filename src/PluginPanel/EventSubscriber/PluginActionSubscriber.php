...
namespace MagmaCore\PluginPanel\EventSubscriber;

use MagmaCore\PluginPanel\Event\ProjectActionEvent;
 ...
 * protected constant
 */
class PluginActionSubscriber implements EventSubscriberInterface
{
    ...
    #[ArrayShape([ProjectActionEvent::NAME => "array"])] public static function getSubscribedEvents(): array
    {
        return [
