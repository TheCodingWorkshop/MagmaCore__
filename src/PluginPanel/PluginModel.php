...
use MagmaCore\PluginPanel\PluginEntity;
use MagmaCore\Base\AbstractBaseModel;
use MagmaCore\Base\Exception\BaseInvalidArgumentException;

class PluginModel extends AbstractBaseModel
{

    /** @var string */
    protected const TABLESCHEMA = 'plugins';
    /** @var string */
    ...
    {
        parent::__construct(self::TABLESCHEMA, self::TABLESCHEMAID, PluginEntity::class);
    }
