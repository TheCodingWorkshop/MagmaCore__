...
class RoleSchema extends DataObjectSchema implements DataObjectSchemaBuilderInterface
{
    ...
    public function createSchema(): string
    {
        ...
        return $this
            ...
            ->row(
                [
                    StringSchema::class => ['type' => 'varchar', 'name' => 'role_name', 'length' => 64, 'null' => false]
                ]
            )
            ->row(
                [
                    StringSchema::class => ['type' => 'text', 'name' => 'role_description', 'null' => false]
                ]
            )
            ->row(
                [
            ...
            ->build(['primary_key' => 'id', 'unique_key' => 'role_name'])
            ->migrateOrIgnore();
    }
}
