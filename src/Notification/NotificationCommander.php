...
class NotificationCommander extends NotificationModel implements ApplicationCommanderInterface
{
    ...
    {
        return $this->findYml('notification');
    }
    ...
    public function getHeaderBuild(object $controller): string
    {
        ...
        $suffix = $this->getHeaderBuildEdit($controller, 'notify_title');
