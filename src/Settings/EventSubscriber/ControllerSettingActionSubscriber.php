 ...
 * protected constant
 */
class ControllerSettingActionSubscriber extends EventDispatcherDefaulter implements EventSubscriberInterface
{
     ...
     * @return array
     */
    #[ArrayShape([ControllerSettingActionEvent::NAME => "array[]"])] public static function getSubscribedEvents(): array
    {
        return [
            ControllerSettingActionEvent::NAME => [
     ...
     *
     * @param ControllerSettingActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashActivateEvent(ControllerSettingActionEvent $event): void
    {
        $event->getObject()->flashMessage('Changes Saved!');
        foreach ($event->getContext() as $data) {
            $event->getObject()->redirect('/admin/' . $data['controller_name'] . '/index');
        }
    }
