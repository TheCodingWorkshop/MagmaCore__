...
class HistorySchema implements DataSchemaBuilderInterface
{
     ...
     * @return void
     */
    public function __construct(DataSchema $schema, DataSchemaBlueprint $blueprint, HistoryModel $model)
    {
        $this->schema = $schema;
    ...
    public function createSchema(): string
    {
        return $this->schema
            ...
            ->row($this->blueprint->varchar('history_path', 100))
            ->row($this->blueprint->text('history_user'))
            ->row($this->blueprint->text('history_browser_agent'))
